...
def parse_config(argv=None):
    ...
    parser.add_argument('--img_folder', type=str, default='Color',
    ...
    parser.add_argument('--vposer_ckpt', type=str, 
                        default=constants.vposer_path,
    ...
    parser.add_argument('--part_segm_fn', default=constants.part_segm_path, type=str,
    ...
    parser.add_argument('--udf_ckpt_path',
                        default='',
                        type=str,
                        help='')
    parser.add_argument('--use_udf', 
                        default=False,
                        type=lambda arg: arg.lower() in ['true', '1'],
                        help='')
    parser.add_argument('--udf_max_dists', 
                        default=[],
                        nargs='*', type=float,
                        help='')
    parser.add_argument('--udf_weights', 
                        default=[],
                        nargs='*', type=float,
                        help='')
    parser.add_argument('--udf_rho',
                        default=1e-1,
                        type=float,
                        help='')
    
    parser.add_argument('--use_ray', 
                        default=False,
                        type=lambda arg: arg.lower() in ['true', '1'],
                        help='')
    parser.add_argument('--ray_dist_weights', 
                        default=[],
                        nargs='*', type=float,
                        help='')
    parser.add_argument('--ray_max_depth',
                        default=0.3,
                        type=float,
                        help='')
    parser.add_argument('--ray_interval',
                        default=0.03,
                        type=float,
                        help='')    
    parser.add_argument('--ray_sv2m_rho',
                        default=5e-2,
                        type=float,
                        help='')
    parser.add_argument('--ray_sv2m_weights', 
                        default=[],
                        nargs='*', type=float,
                        help='')
    parser.add_argument('--ray_m2sv_rho',
                        default=5e-2,
                        type=float,
                        help='')
    parser.add_argument('--ray_m2sv_weights', 
                        default=[],
                        nargs='*', type=float,
                        help='')
    
    parser.add_argument('--shape_opt_stages',
                        default=[], type=int,
                        nargs='*',
                        help='')

    parser.add_argument('--use_vol', 
                        default=True,
                        type=lambda arg: arg.lower() in ['true', '1'],
                        help='')
